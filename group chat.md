...
**Умова:** Користувач без обраної фракції (`faction_club_id` відсутнє або `null`) пише у загальному груповому чаті.
...
- **Коли не діє:**
- Користувач має обрану фракцію (`faction_club_id === "real-madrid"` або `"barcelona"`)
- Повідомлення від бота
