...
- API `/api/faction-members` повертає `faction_rank` як порядковий номер фракції серед унікальних записів у топі (1-5), тому навіть якщо кілька фракцій мають однакові бали, топ-5 депутатів бачать банківку лише якщо саме твоя фракція стоїть на позиції 1-5.
