...
3. **Контейнер стадій (один `div.admin-layout__body`)** — займає `1fr` висоти, чотири колонки `grid-template-columns: 10% 40% 40% 10%` і три рядки: `22% / 70% / 8%`.
   ...
   - Ряд `70%` — під `score-controls` розміщений `div.admin-layout__score-probability` з ймовірністю рахунку (менший шрифт/вага; ховається, якщо немає odds для рахунку).
