...
| ------------------ | -------------------------------- | ----------------------------- |
| Liverpool          | `https://t.me/football_rada/185` | Фракція Ліверпуль             |
| Arsenal            | `https://t.me/football_rada/184` | Фракція Арсенал               |
...
Tip: use the `chat_id` with `thread_id` (e.g. `-1001234567890:21`) when you want to point to a specific thread inside a Telegram forum.
